...
@Component({
  selector: 'app-reformas-presupuestarias',
  templateUrl: './reformas-presupuestarias.component.html',
  styleUrls: ['./reformas-presupuestarias.component.css']
})
export class ReformasPresupuestariasComponent implements OnInit {
  ...
  constructor( 
    private fb: FormBuilder, private _reformas: ReformaService,  private sanitizer: DomSanitizer,
